...
---
module: time
short_description: Perform time synchronization
description:
    - This module performs time synchronization of AIWAF.
...
def main():
    ...
    url = 'https://localhost:223/v1/config/time'
    headers = {"Content-Type": "application/json", "X-ACCESS-TOKEN": token}
    response = requests.put(url, data=json.dumps({}), headers=headers, verify=False)
