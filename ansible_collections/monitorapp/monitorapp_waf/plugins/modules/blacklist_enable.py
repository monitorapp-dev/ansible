...
def blacklistEnable(sToken, nID, nEnable):
    sURL = 'https://localhost:223/v1/policy/admin/ip/blacklist/enable'
...
if __name__ == '__main__':
    ...
    jsResult = blacklistEnable(GetToken(module.params['db_id'], module.params['db_password']), module.params['id'], module.params['enable'])
