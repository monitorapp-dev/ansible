...
DOCUMENTATION = '''
---
module: blacklist_add
short_description: Add IP blacklist rule.
description:
    ...
    detect_target:
        ...
        suboptions:
            ...
            server_ip:
                ...
                type: list
            except_ip:
                description: Exception IP
                type: list
    detect_behavior:
        description: Detect behavior
        type: dict
        required: true
        suboptions:
            action:
                ...
                type: str
            block_page:
                description: Block page rule IP
                type: int
            log:
                description: log
                type: int
...
def main():
    ...
    query = {"enable": module.params['enable'], "name": module.params['name'],
             "detect_target": module.params['detect_target'], "detect_behavior": module.params['detect_behavior'],
             "vlan_id": module.params['vlan_id'], "explain": module.params['explain']}
