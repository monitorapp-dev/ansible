...
DOCUMENTATION = '''
---
module: whitelist_enable
short_description: Chanege whether to use rule.
description:
    - This module changes whether or not to use IP whitelist rules for AIWAF.
...
options:
    ...
    rule_id:
        ...
        required: true
    enable:
        description: whether to use rule.
        type: int
        required: true
'''
...
def main():
    ...
    url = 'https://localhost:223/v1/policy/admin/ip/whitelist/enable'
