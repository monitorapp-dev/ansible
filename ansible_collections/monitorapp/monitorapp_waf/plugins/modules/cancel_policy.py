...
DOCUMENTATION = '''
---
module: cancel_policy
short_description: Cancel default policy.
description:
    - This module  provides the ability to cancel default policy of AIWAF.
...
def main():
    ...
    if is_login is False:
        ...
        url = 'https://localhost:223/v1/policy/base/cancel'
