...
def opmodeGet(sToken):
    sURL = 'https://localhost:223/v1/policy/base/opmode'
    jsHeaders = {"Content-Type": "application/json", "X-ACCESS-TOKEN": sToken}

    response = requests.get(sURL, headers=jsHeaders, verify=False)
...
if __name__ == '__main__':
    ...
    jsResult = opmodeGet(GetToken(module.params['db_id'], module.params['db_password']))
